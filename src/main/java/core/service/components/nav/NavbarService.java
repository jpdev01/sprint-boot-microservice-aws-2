...
public class NavbarService
{
	...
	public Navbar get()
	{
		...
		navbar.addField(new FieldNav(I18nUtils.getString("insertRecords"), "fa fa-bookmark",
			PatternUrl.getInsertRecords(), true, true));
...
//		dropdown.addField(new FieldNav(I18nUtils.getString("customers"),
//			PatternUrl.getListRoute(PatternUrl.getCustomer())));
//		dropdown.addField(new FieldNav(I18nUtils.getString("products"),
//			PatternUrl.getListRoute(PatternUrl.getProduct())));
//		dropdown.addField(new FieldNav(I18nUtils.getString("providers"),
//			PatternUrl.getListRoute(PatternUrl.getProvider())));
//		dropdown.addField(
//			new FieldNav(I18nUtils.getString("users"), PatternUrl.getListRoute(PatternUrl.getUser())));
